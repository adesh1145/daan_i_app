class MpCouponListResp {
  String? result;
  String? status;
  String? message;
  JSONData? jSONData;

  MpCouponListResp({this.result, this.status, this.message, this.jSONData});

  MpCouponListResp.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    status = json['status'];
