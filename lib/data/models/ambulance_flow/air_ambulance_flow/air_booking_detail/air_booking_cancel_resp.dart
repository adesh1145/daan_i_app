class AirBookingCancelResp {
  String? result;
  String? status;
  String? message;
  List<JSONData>? jSONData;

  AirBookingCancelResp({this.result, this.status, this.message, this.jSONData});

  AirBookingCancelResp.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    status = json['status'];
