class CategoryPriceResp {
  String? result;
  String? status;
  String? message;
  List<JSONData>? jSONData;

  CategoryPriceResp({this.result, this.status, this.message, this.jSONData});

  CategoryPriceResp.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    status = json['status'];
...
class JSONData {
  ...
  JSONData.fromJson(Map<String, dynamic> json) {
    ...
    dlTimeDifInSec = json['dl_time_dif_in_sec'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['div_status'] = this.divStatus;
    ...
    data['dl_time_dif_in_sec'] = this.dlTimeDifInSec;
    return data;
  }
}
