class BookingHistoryDetailResp {
  String? result;
  String? status;
  String? message;
  String? text;
  ...
  BookingHistoryDetailResp.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    status = json['status'];
...
class LiveLocation {
  ...
  String? driverTotalDrivenDistance;
  String? updatedAt;
  String? createdAt;
  ...
  LiveLocation(
      {this.driverLiveLocationId,
        ...
        this.driverTotalDrivenDistance,
        this.updatedAt,
        this.createdAt,
  ...
  LiveLocation.fromJson(Map<String, dynamic> json) {
    ...
    driverTotalDrivenDistance = json['driver_total_driven_distance'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['driver_live_location_updated_time'] =
        this.driverLiveLocationUpdatedTime;
    data['driver_total_driven_distance'] = this.driverTotalDrivenDistance;
