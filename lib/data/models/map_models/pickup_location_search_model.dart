...
PickupSearchResponseModel pickupSearchResponseModelFromJson(String str) => PickupSearchResponseModel.fromJson(json.decode(str));

String pickupSearchResponseModelToJson(PickupSearchResponseModel data) => json.encode(data.toJson());

class PickupSearchResponseModel {
    List<Prediction>? predictions;
    String? status;

    PickupSearchResponseModel({
        this.predictions,
        this.status,
    });

    factory PickupSearchResponseModel.fromJson(Map<String, dynamic> json) => PickupSearchResponseModel(
