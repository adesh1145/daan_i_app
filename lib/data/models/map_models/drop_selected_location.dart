...
DropSelectedLocationModel DropSelectedLocationModelFromJson(String str) => DropSelectedLocationModel.fromJson(json.decode(str));

String DropSelectedLocationModelToJson(DropSelectedLocationModel data) => json.encode(data.toJson());

class DropSelectedLocationModel {
    List<dynamic>? htmlAttributions;
    Result? result;
    String? status;

    DropSelectedLocationModel({
        this.htmlAttributions,
        this.result,
        this.status,
    });

    factory DropSelectedLocationModel.fromJson(Map<String, dynamic> json) => DropSelectedLocationModel(
