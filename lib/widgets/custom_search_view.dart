    ...
    switch (fontStyle) {
      case SearchViewFontStyle.robotoNormalN60w12:
        return TextStyle(
          ...
          fontSize: 20.sp * Constants.factor,
    ...
    switch (variant) {
      case SearchViewVariant.fillOutlineStock:
        return OutlineInputBorder(
          ...
          borderSide: BorderSide(color: ColorConstant.searchFieldOutline),
        );
      case SearchViewVariant.fillWhiteBorderCta:
        return OutlineInputBorder(
          borderRadius: _setOutlineBorderRadius(context),
          borderSide: BorderSide(color: ColorConstant.cta),
        );
  ...
  _setFillColor(BuildContext context) {
    switch (variant) {
      ...
      case SearchViewVariant.fillOutlineStock:
        return ColorConstant.white;
      default:
        return ColorConstant.inputField;
    }
  }
