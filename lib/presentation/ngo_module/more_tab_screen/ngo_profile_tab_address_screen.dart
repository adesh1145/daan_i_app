...
class NgoProfileTabAddressScreen extends StatefulWidget {
  const NgoProfileTabAddressScreen({super.key});

  @override
  State<StatefulWidget> createState() {
    return NgoProfileTabAddressScreenState();
  }
}
//CustProfileTabController controller = Get.put(CustProfileTabController());

class NgoProfileTabAddressScreenState extends State<StatefulWidget> {
