        ...
        children: [
          ...
          CustomImageSlider(
              ...
              bannerImageList: <ImageSliderList>[
                ImageSliderList(
                    imgUrl:
                        "https://www.shutterstock.com/image-photo/donate-wooden-letters-on-cork-600w-450955078.jpg"),
                ImageSliderList(
                    imgUrl:
                        "https://img.freepik.com/free-vector/hand-drawn-flat-charity-event-twitch-banner_23-2149398133.jpg?w=1380&t=st=1715277203~exp=1715277803~hmac=86e9bc70d8a0f2520d40d55a9339256a3dc72b191f573f689a8d3d51396e907e"),
                ImageSliderList(
                    imgUrl:
                ...
                ImageSliderList(
                    imgUrl:
                        "https://as1.ftcdn.net/v2/jpg/04/42/50/10/1000_F_442501008_y9L3PGVgRlGSAt6wNvAJpd3GQ4aTtgUp.jpg"),
              ]),
                    ...
                    InkWell(
                      child: Container(
                        ...
                        child: const Padding(
                          ...
                          child: Image(
                              image: AssetImage(
                                  "assets/icons/freshFood_icon.png")),
                        ),
                      ),
                    ),
                    const Text("Food"),
                    ...
                    InkWell(
                      child: Container(
                        ...
                        child: const Padding(
                          padding: EdgeInsets.all(15),
                          child: Image(
                              image: AssetImage("assets/icons/cloth_icon.png")),
                        ),
                      ),
                    ),
                    const Text("Clothes"),
                    ...
                    InkWell(
                      child: Container(
                        ...
                        child: const Padding(
                          ...
                          child: Image(
                              image:
                                  AssetImage("assets/icons/others_icon.png")),
                        ),
                      ),
                    ),
                    const Text(
                          ...
                          children: [
                            Container(
                                ...
                                child: CustomImageView(
                                  imagePath: "assets/icons/insight_icon.png",
                                )),
                            const Text(
                              "Insights",
                              style: TextStyle(
                          ...
                          children: [
                            ...
                            Container(
                                margin: const EdgeInsets.only(
                                    top: 20, left: 10, bottom: 3, right: 6),
                            ...
                            Container(
                                margin: const EdgeInsets.only(
                                    top: 20, left: 6, bottom: 3, right: 10),
                                decoration: BoxDecoration(
                                  boxShadow: const [
                                    BoxShadow(
                                      blurRadius: 1,
                            ...
                            Container(
                                margin: const EdgeInsets.only(
                                    top: 8, left: 10, bottom: 15, right: 6),
                                decoration: BoxDecoration(
                                  boxShadow: const [
                                    BoxShadow(
                                      blurRadius: 1,
                            ...
                            Container(
                                margin: const EdgeInsets.only(
                                    top: 8, left: 6, bottom: 15, right: 10),
                                decoration: BoxDecoration(
                                  boxShadow: const [
                                    BoxShadow(
                                      blurRadius: 1,
