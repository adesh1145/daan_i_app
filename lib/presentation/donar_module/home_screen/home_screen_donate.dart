...
class HomeDonateScreen extends GetWidget<HomeTabController> {
  HomeDonateScreen({super.key});

  HomeTabController controller = Get.put(HomeTabController());
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  border:
                      Border.all(color: const Color.fromARGB(255, 62, 56, 56)),
