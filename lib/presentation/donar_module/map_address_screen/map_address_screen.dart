import 'package:daan_i_app/presentation/donar_module/map_address_screen/add_address_screen.dart';
...
class MapAddressScreen extends StatelessWidget {
  const MapAddressScreen({super.key, this.latLng});
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
        ...
        // initState: (state) {
        //   if (latLng != null) {
        //      state.controller!.updateMarkers(latLng!);
        //   }
        // },
                    ...
                    child: Stack(children: [
                      GoogleMap(
                        ...
                        minMaxZoomPreference:
                            const MinMaxZoomPreference(12, 28),
                      ),
                      Align(
                        ...
                        onTap: () {
                          if (controller.selectedLocation != null) {
                            if (controller.arguments != null) {
                              controller.latLongController.clear();
                              controller.latLongController.text = LatLng(
