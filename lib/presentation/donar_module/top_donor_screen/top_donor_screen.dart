                          ...
                          text: const TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                ...
                                letterSpacing: 1,
                                color:Color.fromARGB(255, 23, 152, 212)
                                )
                              ),
                         ...
                         RichText(
                          ...
                          text: const TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                text: "Bio:",
                                style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,letterSpacing: 1,color:Color.fromARGB(255, 23, 152, 212) )
                              ),

                              TextSpan(
                                text: "Hello my name is shiavm shivam kumar i am from siatpur and curently i am pursuing b.tech degree.",
